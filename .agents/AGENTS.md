...
## Bí kíp phân biệt GET và POST (Restful API)
*   **Chữ GET tiếng Anh nghĩa là:** Xin, lấy, đem về. Dùng khi Client muốn HỎI XIN Server cho xem dữ liệu.
*   **Chữ POST tiếng Anh nghĩa là:** Đăng lên, gửi đi, nộp lên. Dùng khi Client muốn GỬI dữ liệu lên cho Server lưu trữ/xử lý.
