...
public class OrderItemRepository extends BaseRepository implements IOrderItemRepository {
    ...
    private static final String SELECT_ITEMS_BY_ORDER_ID_WITH_NAME =
    ...
    public List<OrderItem> findByOrderID(int orderId) {
        ...
        try (Connection connection = getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_ITEMS_BY_ORDER_ID_WITH_NAME)) {
